            ...
            <div id="container">
                <div id="header-wp">
                    <div class="wp-inner clearfix">
                        <a href="?mod=posts&action=list_post" title="" id="logo" class="fl-left">ADMIN</a>
                        <ul id="main-menu" class="fl-left">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=posts&action=add_post" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=selled&action=list_order" title="">Danh sách đơn hàng</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=selled&action=list_customer" title="">Danh sách khách hàng</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
