...
//if(!is_login() && get_action() != 'login' && get_action() != 'reg' && get_action() != 'reg_success' && get_action() != 'active' && get_action() != 'confirm_email_success' && get_action() != 'newPass' && get_action() != 'resetOk' && get_action() != 'reset_pass'){
