        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="<?php echo $get_page['slug_url']?>-<?php echo $get_page['id']?>.html" title=""><?php echo $get_page['page_name']?></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="main-content fl-right">
            ...
            <div class="section" id="detail-blog-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title"><?php echo $get_page['page_title']?></h3>
                </div>
                <div class="section-detail">
                    <span class="create-date"><?php echo date("d/m/Y h:m:s",$get_page['created_date'])?></span>
                    <span class="creator"><?php echo $get_page['creator']?></span>
                    <div class="detail">
                        <?php echo $get_page['page_content']?>
                    </div>
                </div>
            </div>
            <?php } ?>
