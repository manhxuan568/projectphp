            ...
            <div class="section" id="list-blog-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li class="clearfix">
                            <a href="Bai-viet/<?php echo $item['slug_url']?>-<?php echo $item['id']?>.html" title="" class="thumb fl-left">
                                <img src="admin/<?php echo $item['file_url']?>" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="Bai-viet/<?php echo $item['slug_url']?>-<?php echo $item['id']?>.html" title="" class="title"><?php echo $item['post_title']?></a>
